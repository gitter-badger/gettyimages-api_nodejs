...
module.exports = function () {
    ...
    .reply(200, {
        ...
        var context = this;
        var client = new ApiClient(this.apikey, this.apisecret, this.username, this.password, null, null);
    ...
    this.When(/^I request an access token$/, function (callback) {
        var context = this;
        var client = new ApiClient(this.apikey, this.apisecret, null, null, this.refreshToken, null);
        client.getAccessToken(function (err, response) {
            if (err) {
                callback(err);
            }
